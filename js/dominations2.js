function setTask11() {
	...
	taskMap.startDate = "2021-10-27 20:40:00";
...
function setTask12() {
	...
	taskMap.startDate = "2021-11-06 23:04:00";
...
function setTask13() {
	...
	taskMap.startDate = "2021-11-01 23:34:00";
...
function setTask14() {
	...
	taskMap.startDate = "2021-11-09 15:00:00";
	taskList.push(new Array(type, "타워    ", "Lv.11", " 760만 골드",  9,  0));
	taskList.push(new Array(type, "타워    ", "Lv.11", " 760만 골드",  9,  0));
	taskList.push(new Array(type, "타워    ", "Lv.11", " 760만 골드",  9,  0));
	taskList.push(new Array(type, "타워    ", "Lv.11", " 760만 골드",  9,  0));
...
function setTask15() {
	...
	taskMap.startDate = "2021-10-27 08:10:00";
	taskList.push(new Array(type, "방공타워", "Lv.11", "1900만 골드", 16, 12));
	taskList.push(new Array(type, "방공타워", "Lv.12", "2000만 골드", 17,  0));
	taskList.push(new Array(type, "방공타워", "Lv.12", "2000만 골드", 17,  0));
	taskList.push(new Array(type, "방공타워", "Lv.12", "2000만 골드", 17,  0));
...
function setTask21() {
	...
	taskMap.startDate = "2021-11-03 15:46:00";
...
function setTask22() {
	...
	taskMap.startDate = "2021-11-01 16:03:00";
