function setTask11() {
	...
	taskMap.startDate = "2022-08-05 21:54:00";
...
function setTask12() {
	...
	taskMap.startDate = "2022-08-14 17:05:00";
...
function setTask14() {
	...
	taskMap.startDate = "2022-08-17 05:07:00";
...
function setTask15() {
	...
	var taskMap = new Object();
	var type = "국민5";
	taskMap.title = "1-4. 국민 (0명 → 3명)";
	taskMap.startDate = "2022-09-10 13:49:00";
	taskList.push(new Array(type, "대전차포", "Lv.12", "2200만 골드", 18,  0));
	taskList.push(new Array(type, "대전차포", "Lv.12", "2200만 골드", 18,  0));
	taskList.push(new Array(type, "대전차포", "Lv.12", "2200만 골드", 18,  0));
	taskList.push(new Array(type, "대전차포", "Lv.12", "2200만 골드", 18,  0));
...
function setTask21() {
	...
	taskMap.startDate = "2022-08-14 17:03:00";
...
function setTask22() {
	...
	taskMap.startDate = "2022-08-12 06:48:00";
