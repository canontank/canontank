function setTask11() {
	...
	var type = "국민1";
	taskMap.title = "1-1. 국민 (3명 → 6명)";
	taskMap.startDate = "2022-05-09 19:45:00";
...
function setTask12() {
	...
	taskMap.startDate = "2022-05-22 13:35:00";
...
function setTask13() {
	...
	taskMap.startDate = "2022-05-22 13:25:00";
	taskList.push(new Array(type, "수비대  ", "Lv. 9", " 750만 골드", 10,  0));
...
function setTask14() {
	...
	var taskMap = new Object();
	var type = "국민4";
	taskMap.title = "1-4. 국민 (4명 → 1명)";
	taskMap.startDate = "2022-05-23 19:22:00";
...
function setTask15() {
	...
	taskMap.startDate = "2022-05-18 17:15:00";
	taskList.push(new Array(type, "수비대  ", "Lv. 9", " 750만 골드", 10,  0));
	taskList.push(new Array(type, "협의회  ", "Lv. 4", " 350만 식량",  4,  0));
	taskMap.taskList = taskList;
	allTaskMapList.push(taskMap);
}
...
function setTask21() {
	...
	taskMap.startDate = "2022-05-18 02:38:00";
