function setTask11() {
	...
	taskMap.startDate = "2024-08-19 03:20:00";
	taskList.push(new Array(type, "도서관  ", "Lv.16", "1000만 골드", 16,  0));
...
function setTask12() {
	...
	taskMap.startDate = "2024-09-01 18:28:00";
	taskList.push(new Array(type, "지뢰네개", "Lv.18", "4000만 골드", 15,  8));
	taskList.push(new Array(type, "지뢰네개", "Lv.19", "5200만 골드", 15, 16));
	taskList.push(new Array(type, "지뢰네개", "Lv.19", "5200만 골드", 15, 16));
	taskMap.taskList = taskList;
	allTaskMapList.push(taskMap);
}
...
function setTask13() {
	...
	taskMap.startDate = "2024-08-21 20:05:00";
	taskList.push(new Array(type, "가시철사", "Lv.14", "3200만 골드", 13, 12));
...
function setTask14() {
	...
	taskMap.startDate = "2024-08-29 19:50:00";
	taskList.push(new Array(type, "매복함정", "Lv.12", "2800만 골드", 12,  3));
	taskList.push(new Array(type, "매복함정", "Lv.13", "3200만 골드", 14, 11));
	taskList.push(new Array(type, "매복함정", "Lv.13", "3200만 골드", 14, 11));
	taskMap.taskList = taskList;
	allTaskMapList.push(taskMap);
}
...
function setTask15() {
	...
	taskMap.startDate = "2024-08-24 14:40:00";
...
function setTask21() {
	...
	taskMap.startDate = "2024-08-22 21:18:00";
