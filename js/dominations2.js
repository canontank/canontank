function setTask11() {
	...
	taskMap.startDate = "2024-07-27 12:30:00";
...
function setTask12() {
	...
	taskMap.startDate = "2024-07-18 21:55:00";
	taskList.push(new Array(type, "지뢰네개", "Lv.16", "3000만 골드", 13,  0));
	taskList.push(new Array(type, "지뢰네개", "Lv.17", "3000만 골드", 14, 20)); // 미확인
...
function setTask13() {
	...
	taskMap.startDate = "2024-07-18 00:23:00";
	taskList.push(new Array(type, "가시철사", "Lv.13", "2800만 골드", 12, 14));
...
function setTask14() {
	...
	taskMap.startDate = "2024-07-23 05:55:00";
	taskList.push(new Array(type, "매복함정", "Lv.11", "2400만 골드", 11, 16));
	taskList.push(new Array(type, "매복함정", "Lv.11", "2400만 골드", 11, 16));
	taskMap.taskList = taskList;
	allTaskMapList.push(taskMap);
}
...
function setTask21() {
	...
	taskMap.startDate = "2024-07-16 20:50:00";
...
function setTask22() {
	...
	taskMap.startDate = "2024-07-15 19:45:00";
