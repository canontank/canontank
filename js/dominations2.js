function setTask11() {
	...
	taskMap.startDate = "2020-08-09 19:20:00";
...
function setTask12() {
	...
	taskMap.startDate = "2020-08-16 12:26:00";
	taskList.push(new Array(type, "방공타워", "Lv. 8", "1500만 골드", 13,  0));
	taskList.push(new Array(type, "방공타워", "Lv. 8", "1500만 골드", 13,  0));
	taskList.push(new Array(type, "방공타워", "Lv. 9", "1700만 골드", 14, 12));
	taskList.push(new Array(type, "방공타워", "Lv. 9", "1700만 골드", 14, 12));
...
function setTask13() {
	...
	taskMap.startDate = "2020-08-06 11:26:00";
...
function setTask14() {
	...
	taskMap.startDate = "2020-08-10 17:39:00";
	taskList.push(new Array(type, "숲      ", "Lv. 1", " 600만 골드", 14, 17 ));
...
function setTask15() {
	...
	taskMap.startDate = "2020-08-11 01:35:00";
	taskList.push(new Array(type, "유정    ", "Lv.12", "1800만 골드", 15, 22 ));
	taskList.push(new Array(type, "유정    ", "Lv.12", "1800만 골드", 15, 22 ));
	taskList.push(new Array(type, "유정    ", "Lv.12", "1800만 골드", 15, 22 ));
	taskMap.taskList = taskList;
...
function setTask21() {
	...
	taskMap.startDate = "2020-08-10 22:19:00";
	taskList.push(new Array(type, "소총수  ", "Lv. 1", "1150만 식량", 13,  8 ));
...
function setTask22() {
	...
	taskMap.startDate = "2020-08-16 12:42:00";
	taskList.push(new Array(type, "무장차량", "Lv. 9", "  25만 석유", 16,  4 )); // 디지털
