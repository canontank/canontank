function setTask11() {
	...
	taskMap.startDate = "2021-10-10 18:54:00";
...
function setTask12() {
	...
	taskMap.startDate = "2021-10-21 05:16:00";
	taskList.push(new Array(type, "대전차포", "Lv.11", "1900만 골드", 17,  0));
...
function setTask13() {
	...
	taskMap.startDate = "2021-10-17 04:17:00";
...
function setTask14() {
	...
	taskMap.startDate = "2021-10-22 23:00:00";
...
function setTask15() {
	...
	taskMap.startDate = "2021-10-09 17:54:00";
	taskList.push(new Array(type, "방공타워", "Lv.11", "1900만 골드", 16, 12));
	taskList.push(new Array(type, "방공타워", "Lv.11", "1900만 골드", 16, 12));
	taskList.push(new Array(type, "방공타워", "Lv.12", "2000만 골드", 17,  0));
	taskList.push(new Array(type, "방공타워", "Lv.12", "2000만 골드", 17,  0));
...
function setTask22() {
	...
	taskMap.startDate = "2021-10-17 18:44:00";
