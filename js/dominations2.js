function setTask11() {
	...
	taskMap.startDate = "2023-12-30 01:13:00";
...
function setTask12() {
	...
	taskMap.startDate = "2023-12-30 00:42:00";
...
function setTask13() {
	...
	taskMap.startDate = "2023-12-20 04:30:00";
	taskList.push(new Array(type, "보루    ", "Lv.12", "  33만 석유", 17, 12));
...
function setTask14() {
	...
	taskMap.startDate = "2023-12-25 20:25:00";
	taskList.push(new Array(type, "벙커    ", "Lv. 9", "  30만 석유", 15, 19));
...
function setTask15() {
	...
	taskMap.startDate = "2023-12-19 05:03:00";
	taskList.push(new Array(type, "유정    ", "Lv.16", "2500만 골드", 15,  8));
...
function setTask21() {
	...
	taskList.push(new Array(type, "정찰기  ", "Lv. 1", "  20만 석유",  9, 20));
...
function setTask22() {
	...
	taskMap.startDate = "2023-12-30 01:13:00";
	taskList.push(new Array(type, "전술헬기", "Lv. 1", "  20만 석유", 19,  0));
