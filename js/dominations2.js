function setTask11() {
	...
	taskMap.startDate = "2022-03-02 23:55:00";
...
function setTask12() {
	...
	taskMap.startDate = "2022-03-07 20:08:00";
...
function setTask14() {
	...
	taskMap.startDate = "2022-03-11 20:31:00";
	taskList.push(new Array(type, "타워    ", "Lv.14", "1600만 골드", 12, 12));
	taskList.push(new Array(type, "타워    ", "Lv.15", "1800만 골드", 13,  0));
	taskList.push(new Array(type, "타워    ", "Lv.15", "1800만 골드", 13,  0));
	taskMap.taskList = taskList;
...
function setTask15() {
	...
	taskMap.startDate = "2022-03-13 13:40:00";
	taskList.push(new Array(type, "타워    ", "Lv.14", "1600만 골드", 12, 12));
	taskList.push(new Array(type, "타워    ", "Lv.15", "1800만 골드", 13,  0));
	taskList.push(new Array(type, "타워    ", "Lv.15", "1800만 골드", 13,  0));
	taskMap.taskList = taskList;
...
function setTask21() {
	...
	taskMap.startDate = "2022-03-07 20:02:00";
...
function setTask22() {
	...
	taskList.push(new Array(type, "미확인  ", "Lv. 0", "   6만 석유",  3, 20)); // 미확인
	taskMap.taskList = taskList;
	allTaskMapList.push(taskMap);
}
