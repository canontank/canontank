function setTask11() {
	...
	taskMap.startDate = "2022-10-23 14:00:00";
...
function setTask12() {
	...
	taskMap.startDate = "2022-10-30 11:25:00";
	...
	taskList.push(new Array(type, "씨지두개", "Lv. 3", "  25만 석유", 16, 12));
...
function setTask13() {
	...
	taskMap.startDate = "2022-10-23 14:21:00";
	taskList.push(new Array(type, "골드저장", "Lv.18", "1000만 식량", 11, 12));
...
function setTask15() {
	...
	taskMap.startDate = "2022-10-21 00:35:00";
...
function setTask16() {
	...
	taskMap.startDate = "2022-11-01 21:22:00";
	taskList.push(new Array(type, "신호탄  ", "Lv. 4", "  13만 석유", 13,  0));
	taskList.push(new Array(type, "유인함정", "Lv. 3", " 430만 골드", 10,  0));
...
function setTask17() {
	...
	var taskMap = new Object();
	var type = "국민7";
	taskMap.title = "1-7. 국민 (1명)";
	taskMap.startDate = "2022-11-02 01:14:00";
	taskList.push(new Array(type, "매복함정", "Lv. 3", "12.5만 석유", 16,  0));
	taskList.push(new Array(type, "매복함정", "Lv. 3", "12.5만 석유", 16,  0));
	taskList.push(new Array(type, "매복함정", "Lv. 3", "12.5만 석유", 16,  0));
	taskMap.taskList = taskList;
	allTaskMapList.push(taskMap);
...
function setTask22() {
	...
	taskMap.startDate = "2022-10-21 00:37:00";
