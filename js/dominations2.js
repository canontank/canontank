...
function setTask12() {
	...
	taskMap.startDate = "2020-08-05 01:12:00";
	taskList.push(new Array(type, "방공타워", "Lv. 7", "1400만 골드", 12,  0));
	taskList.push(new Array(type, "방공타워", "Lv. 8", "1500만 골드", 13,  0));
	taskList.push(new Array(type, "방공타워", "Lv. 8", "1500만 골드", 13,  0));
	taskList.push(new Array(type, "방공타워", "Lv. 9", "1700만 골드", 14, 12));
...
function setTask15() {
	...
	taskMap.startDate = "2020-08-10 17:17:00";
	taskList.push(new Array(type, "의회    ", "Lv. 1", "   2만 골드",  1,  0 ));
	taskList.push(new Array(type, "유정    ", "Lv.12", "1800만 골드", 15, 22 ));
	taskList.push(new Array(type, "유정    ", "Lv.12", "1800만 골드", 15, 22 ));
	taskList.push(new Array(type, "유정    ", "Lv.12", "1800만 골드", 15, 22 ));
	taskMap.taskList = taskList;
...
function setTask22() {
	...
	taskMap.startDate = "2020-07-31 19:28:00";
