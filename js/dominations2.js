function setTask11() {
	...
	taskMap.startDate = "2020-06-18 23:56:00";
...
function setTask12() {
	...
	taskMap.startDate = "2020-06-16 17:27:00";
...
function setTask13() {
	...
	taskMap.startDate = "2020-06-13 03:44:00";
	taskList.push(new Array(type, "방공타워", "Lv. 4", " 860만 골드", 10,  0));
	taskList.push(new Array(type, "방공타워", "Lv. 5", "1060만 골드", 10, 12));
	taskList.push(new Array(type, "방공타워", "Lv. 5", "1060만 골드", 10, 12));
	taskList.push(new Array(type, "방공타워", "Lv. 6", "1220만 골드", 11,  0));
...
function setTask14() {
	...
	taskMap.startDate = "2020-06-13 03:57:00";
	taskList.push(new Array(type, "방공타워", "Lv. 5", "1060만 골드", 10, 12));
	taskList.push(new Array(type, "방공타워", "Lv. 5", "1060만 골드", 10, 12));
	taskList.push(new Array(type, "방공타워", "Lv. 6", "1220만 골드", 11,  0));
	taskList.push(new Array(type, "방공타워", "Lv. 6", "1220만 골드", 11,  0));
...
function setTask21() {
	...
	taskMap.startDate = "2020-06-13 03:50:00";
    	taskList.push(new Array(type, "무장차량", "Lv. 6", "  24만 석유", 14,  6 ));
