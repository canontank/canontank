function setTask11() {
	...
	taskMap.startDate = "2023-01-11 23:07:00";
...
function setTask12() {
	...
	taskMap.startDate = "2023-01-25 23:27:00";
...
function setTask13() {
	...
	taskMap.startDate = "2023-01-21 01:06:00";
...
function setTask15() {
	...
	taskMap.startDate = "2023-01-23 01:00:00";
	taskList.push(new Array(type, "유인함정", "Lv. 5", " 700만 골드", 12,  0));
	taskList.push(new Array(type, "매복함정", "Lv.10", " 600만 골드", 12,  0));
...
function setTask16() {
	...
	taskMap.startDate = "2023-01-23 01:00:00";
	taskList.push(new Array(type, "지뢰    ", "Lv. 8", " 150만 골드",  7,  0));
	taskList.push(new Array(type, "지뢰    ", "Lv. 9", " 150만 골드",  9,  0));
...
function setTask22() {
	...
	taskMap.startDate = "2023-01-27 14:47:00";
