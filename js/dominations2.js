function setTask11() {
	...
	taskMap.startDate = "2020-10-04 12:43:00";
	taskList.push(new Array(type, "수비대  ", "Lv. 7", "1500만 골드",  3,  5));
...
function setTask13() {
	...
	taskMap.startDate = "2020-10-04 12:09:00";
	taskList.push(new Array(type, "방공타워", "Lv. 9", "1700만 골드", 14, 12));
	taskList.push(new Array(type, "방공타워", "Lv.10", "1800만 골드", 16,  6));
	taskList.push(new Array(type, "방공타워", "Lv.10", "1800만 골드", 16,  6));
	taskMap.taskList = taskList;
...
function setTask14() {
	...
	taskMap.startDate = "2020-10-06 22:40:00";
...
function setTask15() {
	...
	taskMap.startDate = "2020-09-19 01:26:00";
	taskList.push(new Array(type, "미샬격납", "Lv. 9", "  25만 석유", 17,  2 ));
	taskList.push(new Array(type, "유정    ", "Lv.12", "1800만 골드", 15, 23 ));
	taskList.push(new Array(type, "유정    ", "Lv.12", "1800만 골드", 15, 23 ));
	taskMap.taskList = taskList;
	allTaskMapList.push(taskMap);
...
function setTask21() {
	...
	taskMap.startDate = "2020-09-30 00:06:00";
...
function setTask22() {
	...
	taskMap.startDate = "2020-10-04 12:36:00";
	taskList.push(new Array(type, "공병    ", "Lv. 9", "1200만 식량", 13,  8 ));
