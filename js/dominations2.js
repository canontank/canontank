function setTask11() {
	...
	taskMap.startDate = "2022-05-26 19:27:00";
...
function setTask12() {
	...
	taskMap.startDate = "2022-05-22 11:05:00";
...
function setTask13() {
	...
	taskMap.startDate = "2022-05-22 10:55:00";
	taskList.push(new Array(type, "수비대  ", "Lv. 9", " 750만 골드", 10,  0));
...
function setTask14() {
	...
	taskMap.startDate = "2022-05-26 19:17:00";
...
function setTask15() {
	...
	var taskMap = new Object();
	var type = "국민5";
	taskMap.title = "1-5. 국민 (4명 → 0명)";
	taskMap.startDate = "2022-05-27 08:16:00";
	taskList.push(new Array(type, "협의회  ", "Lv. 4", " 500만 식량",  5,  0));
	taskMap.taskList = taskList;
	allTaskMapList.push(taskMap);
}
...
function setTask21() {
	...
	taskList.push(new Array(type, "미국    ", "Lv. 8", "  11만 석유", 11, 12)); // 미확인
	taskList.push(new Array(type, "에티오피", "Lv. 8", "  11만 석유", 11, 12)); // 미확인
	taskMap.taskList = taskList;
	allTaskMapList.push(taskMap);
}
...
function setTask22() {
	...
	taskList.push(new Array(type, "러시아  ", "Lv. 7", " 800만 골드", 10, 10)); // 미확인
