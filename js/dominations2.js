function setTask11() {
	...
	taskMap.startDate = "2022-09-24 05:30:00";
...
function setTask12() {
	...
	taskMap.startDate = "2022-09-12 08:53:00";
...
function setTask13() {
	...
	taskMap.startDate = "2022-09-20 03:37:00";
...
function setTask14() {
	...
	taskMap.startDate = "2022-09-20 21:56:00";
...
function setTask15() {
	...
	taskMap.startDate = "2022-09-19 00:43:00";
	taskList.push(new Array(type, "씨지아이", "Lv. 1", "  10만 석유", 15, 12));
	taskList.push(new Array(type, "씨지아이", "Lv. 2", "  12만 석유", 16,  0)); // 미확인
...
function setTask16() {
	...
	taskMap.startDate = "2022-09-14 22:44:00";
	taskList.push(new Array(type, "신호탄  ", "Lv. 2", " 5.5만 석유", 11,  0));
	taskList.push(new Array(type, "신호탄  ", "Lv. 3", "12.5만 석유", 13,  0));
	taskList.push(new Array(type, "신호탄  ", "Lv. 3", "12.5만 석유", 13,  0));
	taskList.push(new Array(type, "신호탄  ", "Lv. 3", "12.5만 석유", 13,  0));
	taskMap.taskList = taskList;
	allTaskMapList.push(taskMap);
...
function setTask21() {
	...
	taskMap.startDate = "2022-09-22 01:16:00";
...
function setTask22() {
	...
	taskMap.startDate = "2022-09-14 22:28:00";
