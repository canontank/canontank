function setTask11() {
	...
	taskMap.startDate = "2020-10-24 12:15:00";
	taskList.push(new Array(type, "성채    ", "Lv. 6", " 600만 식량",  9,  0));
...
function setTask12() {
	...
	taskMap.startDate = "2020-10-24 12:22:00";
...
function setTask13() {
	...
	taskMap.startDate = "2020-10-18 19:30:00";
	taskList.push(new Array(type, "방공타워", "Lv. 9", "1700만 골드", 14, 12));
	taskList.push(new Array(type, "방공타워", "Lv.10", "1800만 골드", 16,  6));
	taskList.push(new Array(type, "방공타워", "Lv.10", "1800만 골드", 16,  6));
	taskMap.taskList = taskList;
...
function setTask14() {
	...
	taskMap.startDate = "2020-10-24 12:24:00";
	taskList.push(new Array(type, "사원    ", "Lv. 7", " 600만 식량", 10,  0 ));
...
function setTask15() {
	...
	taskMap.startDate = "2020-10-09 11:27:00";
	taskList.push(new Array(type, "유정    ", "Lv.12", "1800만 골드", 15, 23 ));
	taskList.push(new Array(type, "유정    ", "Lv.12", "1800만 골드", 15, 23 ));
	taskMap.taskList = taskList;
	allTaskMapList.push(taskMap);
...
function setTask21() {
	...
	taskMap.startDate = "2020-10-17 13:19:00";
...
function setTask22() {
	...
	taskMap.startDate = "2020-10-18 19:20:00";
