...
function setTask12() {
	...
	taskMap.startDate = "2020-08-31 23:47:00";
	taskList.push(new Array(type, "사원    ", "Lv. 6", " 800만 식량",  8,  0));
	taskList.push(new Array(type, "방공타워", "Lv. 8", "1500만 골드", 13,  0));
	taskList.push(new Array(type, "방공타워", "Lv. 9", "1700만 골드", 14, 12));
	taskList.push(new Array(type, "방공타워", "Lv. 9", "1700만 골드", 14, 12));
	taskList.push(new Array(type, "방공타워", "Lv.10", "1800만 골드", 16,  6));
...
function setTask13() {
	...
	taskMap.startDate = "2020-08-31 23:45:00";
...
function setTask14() {
	...
	taskMap.startDate = "2020-08-31 23:16:00";
...
function setTask15() {
	...
	taskMap.startDate = "2020-08-31 23:17:00";
	taskList.push(new Array(type, "숲      ", "Lv. 1", " 600만 골드", 14, 17 ));
	taskList.push(new Array(type, "유정    ", "Lv.12", "1800만 골드", 15, 22 ));
	taskList.push(new Array(type, "유정    ", "Lv.12", "1800만 골드", 15, 22 ));
	taskMap.taskList = taskList;
