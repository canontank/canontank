...
function setTask12() {
	...
	taskMap.startDate = "2022-04-15 14:16:00";
	taskList.push(new Array(type, "협의회  ", "Lv. 2", " 100만 식량",  1,  0));
...
function setTask13() {
	...
	taskMap.startDate = "2022-04-10 01:48:00";
...
function setTask21() {
	...
	taskMap.startDate = "2022-04-10 01:35:00";
	taskList.push(new Array(type, "에티오피", "Lv. 5", "   6만 석유",  7, 14));
...
function setTask22() {
	...
	taskMap.startDate = "2022-04-10 01:35:00";
	taskList.push(new Array(type, "필리핀  ", "Lv. 5", "   6만 석유",  7, 14));
