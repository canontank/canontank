...
function setTask12() {
	...
	taskMap.startDate = "2023-08-15 16:52:00";
...
function setTask13() {
	...
	taskMap.startDate = "2023-08-22 23:50:00";
...
function setTask14() {
	...
	taskMap.startDate = "2023-08-12 12:15:00";
...
function setTask15() {
	...
	taskMap.startDate = "2023-08-23 00:00:00";
...
function setTask21() {
	...
	taskMap.startDate = "2023-08-22 23:25:00";
	taskList.push(new Array(type, "개틀링  ", "Lv.16", "  28만 석유", 18, 12));
...
function setTask22() {
	...
	taskMap.startDate = "2023-08-23 22:25:00";
	taskList.push(new Array(type, "페트라  ", "Lv.11", "   1만 석유",  1, 22));
	taskList.push(new Array(type, "손자    ", "Lv.11", "   1만 석유",  1, 22));
	taskList.push(new Array(type, "게릴라  ", "Lv.16", "  28만 석유", 18, 12));
