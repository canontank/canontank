function setTask11() {
	...
	taskMap.startDate = "2024-09-27 13:35:00";
	taskList.push(new Array(type, "수비대  ", "Lv.15", "2000만 골드", 15, 19));
	taskList.push(new Array(type, "수비대  ", "Lv.15", "2000만 골드", 15, 19));
...
function setTask12() {
	...
	taskMap.startDate = "2024-09-24 15:35:00";
	taskList.push(new Array(type, "대학    ", "Lv.12", "1750만 골드", 17,  0));
...
function setTask13() {
	...
	taskMap.startDate = "2024-09-27 13:35:00";
	taskList.push(new Array(type, "씨지아이", "Lv. 4", "  30만 석유", 16, 22));
	taskList.push(new Array(type, "보루    ", "Lv. 3", " 700만 골드",  2,  9));
	taskList.push(new Array(type, "보루    ", "Lv. 3", " 700만 골드",  2,  9));
	taskList.push(new Array(type, "보루    ", "Lv. 4", " 900만 골드",  9,  2));
	taskList.push(new Array(type, "보루    ", "Lv. 4", " 900만 골드",  9,  2));
	taskList.push(new Array(type, "보루    ", "Lv. 4", " 900만 골드",  9,  2));
	taskList.push(new Array(type, "보루    ", "Lv. 4", " 900만 골드",  9,  2));
	taskList.push(new Array(type, "보루    ", "Lv. 4", " 900만 골드",  9,  2));
...
function setTask15() {
	...
	taskMap.startDate = "2024-10-03 15:25:00";
	taskList.push(new Array(type, "지뢰    ", "Lv.19", "4400만 골드", 15, 16));
...
function setTask16() {
	...
	taskMap.startDate = "2024-09-19 20:55:00";
	taskList.push(new Array(type, "가시철사", "Lv.15", "4000만 골드", 14,  9));
...
function setTask17() {
	...
	taskMap.startDate = "2024-09-25 02:55:00";
	taskList.push(new Array(type, "유인함정", "Lv. 6", "2700만 골드", 12,  0));
	taskList.push(new Array(type, "매복함정", "Lv.13", "2400만 골드", 14, 11));
	taskList.push(new Array(type, "매복함정", "Lv.13", "2400만 골드", 14, 11));
	taskList.push(new Array(type, "매복함정", "Lv.13", "2400만 골드", 14, 11));
	taskMap.taskList = taskList;
	allTaskMapList.push(taskMap);
...
function setTask18() {
	...
	taskMap.startDate = "2024-09-27 15:50:00";
	taskList.push(new Array(type, "무인함정", "Lv.13", "  30만 석유", 16, 10));
	taskList.push(new Array(type, "씨지아이", "Lv. 4", "  15만 석유", 16, 22));
	taskList.push(new Array(type, "씨지아이", "Lv. 4", "  15만 석유", 16, 22));
	taskList.push(new Array(type, "미샬포대", "Lv.12", " 850만 골드", 14,  7));
	taskMap.taskList = taskList;
	allTaskMapList.push(taskMap);
...
function setTask21() {
	...
	taskMap.startDate = "2024-09-30 18:20:00";
...
function setTask22() {
	...
	taskMap.startDate = "2024-09-21 22:40:00";
