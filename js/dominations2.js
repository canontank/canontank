function setTask11() {
	...
	taskMap.startDate = "2021-08-21 18:25:00";
...
function setTask12() {
	...
	taskMap.startDate = "2021-08-11 21:10:00";
...
function setTask13() {
	...
	taskMap.startDate = "2021-08-25 02:20:00";
...
function setTask14() {
	...
	taskMap.startDate = "2021-08-19 14:00:00";
	taskList.push(new Array(type, "방공타워", "Lv.10", "1800만 골드", 16,  6));
...
function setTask21() {
	...
	taskMap.startDate = "2021-08-17 19:30:00";
...
function setTask22() {
	...
	taskMap.startDate = "2021-08-18 19:30:00";
	taskList.push(new Array(type, "전차    ", "Lv. 1", "1800만 식량", 14,  6 ));
	taskList.push(new Array(type, "박격포병", "Lv. 1", "1505만 식량", 13,  7 ));
	taskMap.taskList = taskList;
	allTaskMapList.push(taskMap);
}
