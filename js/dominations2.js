function setTask11() {
	...
	taskMap.startDate = "2023-06-19 23:35:00";
	taskList.push(new Array(type, "박격포  ", "Lv. 1", " 100만 골드",  0,  2));
...
function setTask12() {
	...
	taskMap.startDate = "2023-06-14 22:50:00";
...
function setTask13() {
	...
	taskMap.startDate = "2023-06-14 22:30:00";
...
function setTask15() {
	...
	taskList.push(new Array(type, "미샬포대", "Lv. 2", "1000만 골드",  6,  0));
	taskMap.taskList = taskList;
	allTaskMapList.push(taskMap);
}
...
function setTask16() {
	...
	taskMap.startDate = "2023-07-02 22:50:00";
	taskList.push(new Array(type, "무장함정", "Lv. 1", "   7만 석유", 12, 12));
	taskList.push(new Array(type, "무장함정", "Lv. 2", "   7만 석유", 12, 12));
	taskMap.taskList = taskList;
	allTaskMapList.push(taskMap);
}
...
function setTask21() {
	...
	taskMap.startDate = "2023-06-18 19:33:00";
	taskList.push(new Array(type, "인도    ", "Lv. 8", " 720만 골드", 11, 11));
	taskList.push(new Array(type, "주코프  ", "Lv. 2", "   1만 석유",  0,  8));
	taskMap.taskList = taskList;
	allTaskMapList.push(taskMap);
}
...
function setTask22() {
	...
	taskMap.startDate = "2023-06-12 00:09:00";
	taskList.push(new Array(type, "체로키  ", "Lv. 8", " 720만 식량", 11, 11));
	taskList.push(new Array(type, "처칠    ", "Lv. 2", "   1만 석유",  0,  8));
	taskList.push(new Array(type, "처칠    ", "Lv. 3", "   1만 석유",  0,  8));
	taskList.push(new Array(type, "처칠    ", "Lv. 4", "   1만 석유",  0,  8));
	taskMap.taskList = taskList;
	allTaskMapList.push(taskMap);
}
