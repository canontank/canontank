...
function setTask13() {
	...
	taskMap.startDate = "2021-02-03 01:57:00";
	taskList.push(new Array(type, "골드저장", "Lv.12", " 200만 식량",  6,  0));
	taskList.push(new Array(type, "골드저장", "Lv.17", " 950만 식량", 11,  0));
	taskList.push(new Array(type, "골드저장", "Lv.17", " 950만 식량", 11,  0));
	taskList.push(new Array(type, "골드저장", "Lv.17", " 950만 식량", 11,  0));
	taskMap.taskList = taskList;
	allTaskMapList.push(taskMap);
...
function setTask14() {
	...
	taskMap.startDate = "2021-02-03 01:57:00";
	taskList.push(new Array(type, "식량저장", "Lv.12", " 200만 골드",  6,  0));
...
function setTask21() {
	...
	taskMap.startDate = "2021-01-30 02:36:00";
	taskList.push(new Array(type, "정보전투", "Lv. 5", "  19만 석유",  9,  0 ));
	taskList.push(new Array(type, "정보전투", "Lv. 6", "  19만 석유",  9,  0 ));
	taskList.push(new Array(type, "정보폭격", "Lv. 1", "  19만 석유",  9,  0 ));
	taskList.push(new Array(type, "정보폭격", "Lv. 2", "  19만 석유",  9,  0 ));
	taskList.push(new Array(type, "정보폭격", "Lv. 3", "  19만 석유",  9,  0 ));
...
function setTask22() {
	...
	taskMap.startDate = "2021-02-01 20:30:00";
	taskList.push(new Array(type, "정보수송", "Lv. 6", "  19만 석유",  9,  0 ));
	taskList.push(new Array(type, "정보정찰", "Lv. 1", "  19만 석유",  9,  0 ));
	taskList.push(new Array(type, "정보정찰", "Lv. 2", "  19만 석유",  9,  0 ));
	taskList.push(new Array(type, "정보정찰", "Lv. 3", "  19만 석유",  9,  0 ));
	taskList.push(new Array(type, "정보정찰", "Lv. 4", "  19만 석유",  9,  0 ));
