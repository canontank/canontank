function setTask11() {
	...
	taskMap.startDate = "2023-03-02 00:15:00";
...
function setTask12() {
	...
	taskMap.startDate = "2023-03-12 00:26:00";
...
function setTask13() {
	...
	taskMap.startDate = "2023-02-27 22:05:00";
...
function setTask14() {
	...
	taskMap.startDate = "2023-03-05 00:47:00";
...
function setTask15() {
	...
	taskMap.startDate = "2023-03-05 21:53:00";
	taskList.push(new Array(type, "미샬포대", "Lv. 8", " 500만 골드", 12,  0));
...
function setTask21() {
	...
	taskMap.startDate = "2023-03-07 15:20:00";
	taskList.push(new Array(type, "일제사격", "Lv. 1", " 800만 식량", 10,  8));
	taskList.push(new Array(type, "사보타주", "Lv. 1", " 800만 식량", 10,  8));
...
function setTask22() {
	...
	taskMap.startDate = "2023-03-12 00:22:00";
	taskList.push(new Array(type, "보호    ", "Lv. 1", " 800만 식량", 10,  8));
	taskList.push(new Array(type, "응급처치", "Lv. 1", " 800만 식량", 10,  8));
