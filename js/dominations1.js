function setTask11() {
	...
	taskMap.startDate = "2021-06-24 11:11:00";
	taskList.push(new Array(type, "씨지아이", "Lv. 2", "10.5만 석유", 15, 23));
...
function setTask13() {
	...
	taskMap.startDate = "2021-06-17 12:15:00";
...
function setTask14() {
	...
	taskMap.startDate = "2021-06-20 19:40:00";
...
function setTask15() {
	...
	taskMap.startDate = "2021-06-17 11:49:00";
	taskList.push(new Array(type, "방공타워", "Lv.11", "1900만 골드", 16, 12));
	taskList.push(new Array(type, "방공타워", "Lv.11", "1900만 골드", 16, 12));
	taskMap.taskList = taskList;
	allTaskMapList.push(taskMap);
...
function setTask21() {
	...
	taskMap.startDate = "2021-06-24 11:23:00";
	taskList.push(new Array(type, "전차    ", "Lv.16", "2140만 식량", 15,  6));
...
function setTask22() {
	...
	taskMap.startDate = "2021-06-13 16:01:00";
	...
	taskList.push(new Array(type, "강습차량", "Lv.16", "2140만 식량", 15,  6));
	taskMap.taskList = taskList;
	allTaskMapList.push(taskMap);
}
