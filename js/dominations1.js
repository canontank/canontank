function setTask11() {
	...
	taskMap.startDate = "2021-02-09 04:15:00";
...
function setTask12() {
	...
	taskMap.startDate = "2021-02-23 16:00:00";
...
function setTask13() {
	...
	taskMap.startDate = "2021-02-20 18:07:00";
...
function setTask14() {
	...
	taskList.push(new Array(type, "골드창고", "Lv.17", " 945만 식량", 11,  0));
	taskList.push(new Array(type, "골드창고", "Lv.12", " 200만 식량",  6,  0));
...
function setTask21() {
	...
	taskMap.startDate = "2021-02-15 23:40:00";
	taskList.push(new Array(type, "정보정찰", "Lv. 6", "  20만 석유",  9,  0)); // 정보화
	taskList.push(new Array(type, "게릴라  ", "Lv.13", "  25만 석유", 17,  3 )); // 정보화
	taskList.push(new Array(type, "중전차  ", "Lv.12", "  27만 석유", 17,  3 )); // 정보화
...
function setTask22() {
	...
	taskMap.startDate = "2021-02-19 23:56:00";
	taskList.push(new Array(type, "바주카  ", "Lv.11", "  26만 석유", 17,  3 )); // 정보화
