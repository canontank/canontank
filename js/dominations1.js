function setTask11() {
	...
	taskMap.startDate = "2021-05-22 18:25:00";
...
function setTask12() {
	...
	taskMap.startDate = "2021-06-06 19:33:00";
...
function setTask13() {
	...
	taskMap.startDate = "2021-06-01 11:07:00";
...
function setTask14() {
	...
	taskMap.startDate = "2021-06-06 19:09:00";
...
function setTask15() {
	...
	taskMap.startDate = "2021-05-29 08:04:00";
	taskList.push(new Array(type, "방공타워", "Lv.11", "1900만 골드", 16, 12));
	taskList.push(new Array(type, "방공타워", "Lv.11", "1900만 골드", 16, 12));
	taskList.push(new Array(type, "방공타워", "Lv.11", "1900만 골드", 16, 12));
	taskMap.taskList = taskList;
...
function setTask21() {
	...
	taskMap.startDate = "2021-06-06 19:28:00";
...
function setTask22() {
	...
	taskMap.startDate = "2021-06-06 19:28:00";
	taskList.push(new Array(type, "클레오  ", "Lv.13", " 3.0만 석유",  1, 16));
