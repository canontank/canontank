function setTask11() {
	...
	taskMap.startDate = "2020-03-10 02:55:00";
...
function setTask12() {
	...
	var taskMap = new Object();
	var type = "국민2";
	taskMap.title = "1-2. 국민 (3명 → 4명)";
	taskMap.startDate = "2020-03-10 23:09:00";
...
function setTask14() {
	...
	var taskMap = new Object();
	var type = "국민4";
	taskMap.title = "1-4. 국민 (3명 → 6명)";
	taskMap.startDate = "2020-03-15 13:11:00";
...
function setTask15() {
	...
	var taskMap = new Object();
	var type = "국민5";
	taskMap.title = "1-5. 국민 (3명 → 0명)";
	taskMap.startDate = "2020-03-10 03:17:00";
	taskList.push(new Array(type, "유정    ", "Lv.11", "1600만 골드", 14, 12)); // 디지털
	taskList.push(new Array(type, "유정    ", "Lv.11", "1600만 골드", 14, 12)); // 디지털
	taskList.push(new Array(type, "유정    ", "Lv.11", "1600만 골드", 14, 12)); // 디지털
	taskMap.taskList = taskList;
...
function setTask21() {
	...
	taskMap.startDate = "2020-03-18 00:11:00";
...
function setTask22() {
	...
	taskMap.startDate = "2020-03-04 13:49:00";
	taskList.push(new Array(type, "무장차량", "Lv. 8", "  25만 석유", 16,  4)); // 디지털
	taskList.push(new Array(type, "엠알엘  ", "Lv. 4", "21.5만 석유", 14,  6)); // 우주				
