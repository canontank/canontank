function setTask11() {
	...
	taskMap.startDate = "2022-02-02 06:41:00";
...
function setTask12() {
	...
	taskMap.startDate = "2022-01-27 20:24:00";
	taskList.push(new Array(type, "보루    ", "Lv. 4", " 720만 골드", 14,  0));
	taskList.push(new Array(type, "보루    ", "Lv. 4", " 720만 골드", 14,  0));
	taskList.push(new Array(type, "보루    ", "Lv. 5", " 840만 골드", 14,  0));
	taskList.push(new Array(type, "보루    ", "Lv. 5", " 840만 골드", 14,  0));
	taskList.push(new Array(type, "보루    ", "Lv. 5", " 840만 골드", 14,  0));
	taskList.push(new Array(type, "보루    ", "Lv. 5", " 840만 골드", 14,  0));
	taskList.push(new Array(type, "보루    ", "Lv. 5", " 840만 골드", 14,  0));
...
function setTask13() {
	...
	taskMap.startDate = "2022-02-07 02:33:00";
...
function setTask14() {
	...
	taskMap.startDate = "2022-02-09 20:04:00";
...
function setTask15() {
	...
	taskMap.startDate = "2022-02-05 11:00:00";
	taskList.push(new Array(type, "보루    ", "Lv. 4", " 720만 골드", 14,  0));
...
function setTask21() {
	...
	taskMap.startDate = "2022-01-27 20:55:00";
