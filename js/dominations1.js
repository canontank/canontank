...
function setTask12() {
	...
	taskMap.startDate = "2024-08-16 00:30:00";
	taskList.push(new Array(type, "매복네개", "Lv.11", "2400만 골드", 11, 17));
	taskList.push(new Array(type, "매복네개", "Lv.12", "2800만 골드", 12,  2));
	taskList.push(new Array(type, "매복네개", "Lv.12", "2800만 골드", 12,  2));
	taskMap.taskList = taskList;
	allTaskMapList.push(taskMap);
}
...
function setTask13() {
	...
	taskMap.startDate = "2024-08-17 07:00:00";
...
function setTask14() {
	...
	taskMap.startDate = "2024-08-19 03:30:00";
	taskList.push(new Array(type, "지뢰네개", "Lv.17", "4000만 골드", 14, 20));
	taskList.push(new Array(type, "지뢰네개", "Lv.17", "4000만 골드", 14, 20));
	taskMap.taskList = taskList;
	allTaskMapList.push(taskMap);
}
...
function setTask15() {
	...
	taskMap.startDate = "2024-08-09 20:53:00";
...
function setTask16() {
	...
	taskMap.startDate = "2024-08-14 02:50:00";
	taskList.push(new Array(type, "씨지아이", "Lv. 4", "14.5만 석유", 17, 0));
	taskList.push(new Array(type, "씨지아이", "Lv. 4", "14.5만 석유", 17, 0));
	taskList.push(new Array(type, "씨지아이", "Lv. 4", "14.5만 석유", 17, 0));
...
function setTask22() {
	...
	taskMap.startDate = "2024-08-05 19:30:00";
