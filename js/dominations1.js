function setTask11() {
	...
	taskMap.startDate = "2022-10-17 21:07:00";
...
function setTask12() {
	...
	taskMap.startDate = "2022-10-13 03:09:00";
...
function setTask13() {
	...
	taskMap.startDate = "2022-10-23 03:48:00";
	taskList.push(new Array(type, "골드저장", "Lv.18", "1000만 식량", 11, 12));
...
function setTask14() {
	...
	taskMap.startDate = "2022-10-19 20:31:00";
...
function setTask15() {
	...
	var taskMap = new Object();
	var type = "국민5";
	taskMap.title = "1-5. 국민 (2명 → 0명)";
	taskMap.startDate = "2022-10-17 21:31:00";
...
function setTask16() {
	...
	var taskMap = new Object();
	var type = "국민6";
	taskMap.title = "1-6. 국민 (1명 → 2명)";
	taskMap.startDate = "2022-10-17 21:08:00";
	taskList.push(new Array(type, "무장매복", "Lv. 3", "12.4만 석유", 16,  0));
	taskList.push(new Array(type, "신호탄  ", "Lv. 3", "  10만 석유", 12,  0)); // 미확인
	taskList.push(new Array(type, "신호탄  ", "Lv. 4", "12.4만 석유", 13,  0));
	taskList.push(new Array(type, "씨지아이", "Lv. 3", "12.4만 석유", 16, 12));
	taskList.push(new Array(type, "씨지아이", "Lv. 3", "12.4만 석유", 16, 12));
	taskList.push(new Array(type, "씨지아이", "Lv. 3", "12.4만 석유", 16, 12));
...
function setTask17() {
	...
	taskMap.startDate = "2022-10-17 21:13:00";
	taskList.push(new Array(type, "신호탄  ", "Lv. 2", " 5.5만 석유", 11,  0));
	taskList.push(new Array(type, "신호탄  ", "Lv. 4", "12.4만 석유", 13,  0));
	taskList.push(new Array(type, "신호탄  ", "Lv. 4", "12.4만 석유", 13,  0));
	taskMap.taskList = taskList;
	allTaskMapList.push(taskMap);
...
function setTask21() {
	...
	taskMap.startDate = "2022-10-12 00:30:00";
...
function setTask22() {
	...
	taskMap.startDate = "2022-10-19 20:28:00";
