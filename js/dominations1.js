function setTask11() {
	...
	taskMap.startDate = "2021-07-11 19:50:00";
...
function setTask12() {
	...
	taskMap.startDate = "2021-07-25 22:11:00";
...
function setTask13() {
	...
	taskMap.startDate = "2021-07-25 22:38:00";
...
function setTask14() {
	...
	taskMap.startDate = "2021-07-21 02:16:00";
...
function setTask15() {
	...
	taskMap.startDate = "2021-07-25 22:40:00";
	taskList.push(new Array(type, "의회    ", "Lv.11", "1900만 골드", 13,  2));
	taskList.push(new Array(type, "타워    ", "Lv.15", "1710만 골드", 13,  0));
	taskList.push(new Array(type, "타워    ", "Lv.15", "1710만 골드", 13,  0));
	taskList.push(new Array(type, "타워    ", "Lv.15", "1710만 골드", 13,  0));
	taskList.push(new Array(type, "타워    ", "Lv.15", "1710만 골드", 13,  0));
...
function setTask21() {
	...
	taskMap.startDate = "2021-07-27 19:00:00";
...
function setTask22() {
	...
	taskMap.startDate = "2021-07-11 20:10:00";
