function setTask11() {
	...
	taskMap.startDate = "2021-12-30 08:08:00";
...
function setTask12() {
	...
	taskMap.startDate = "2022-01-04 02:12:00";
...
function setTask13() {
	...
	taskMap.startDate = "2021-12-19 17:20:00";
	taskList.push(new Array(type, "방공타워", "Lv.12", "2000만 골드", 17,  0));
	taskList.push(new Array(type, "미샬두개", "Lv.10", "1620만 골드", 15,  2));
	taskList.push(new Array(type, "미샬두개", "Lv.10", "1620만 골드", 15,  2));
...
function setTask14() {
	...
	taskMap.startDate = "2021-12-22 00:03:00";
...
function setTask15() {
	...
	taskMap.startDate = "2022-01-04 21:01:00";
...
function setTask21() {
	...
	taskMap.startDate = "2021-12-27 00:31:00";
	taskList.push(new Array(type, "유명바주", "Lv.12", "  27만 석유", 17, 14));
...
function setTask22() {
	...
	taskMap.startDate = "2021-12-19 17:33:00";
	taskList.push(new Array(type, "유명게릴", "Lv.14", "  26만 석유", 17, 14));
