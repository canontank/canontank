...
function setTask13() {
	...
	var taskMap = new Object();
	var type = "국민3";
	taskMap.title = "1-3. 국민 (6명 → 4명)";
	taskMap.startDate = "2023-05-15 21:50:00";
	taskList.push(new Array(type, "미샬세개", "Lv.11", "3030만 골드", 15, 12));
	taskList.push(new Array(type, "미샬세개", "Lv.12", "3750만 골드", 16,  0));
	taskList.push(new Array(type, "미샬세개", "Lv.13", "4500만 골드", 17, 12));
...
function setTask15() {
	...
	taskList.push(new Array(type, "매복네개", "Lv.10", "2200만 골드", 12, 12));
	taskList.push(new Array(type, "매복네개", "Lv.10", "2200만 골드", 12, 12));
	taskMap.taskList = taskList;
	allTaskMapList.push(taskMap);
}
...
function setTask21() {
	...
	taskMap.startDate = "2023-05-26 01:20:00";
	taskList.push(new Array(type, "노부나가", "Lv.29", "   7만 석유",  2, 20));
...
function setTask22() {
	...
	taskMap.startDate = "2023-05-26 01:20:00";
	taskList.push(new Array(type, "나폴레옹", "Lv.29", "   7만 석유",  2, 20));
