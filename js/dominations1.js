function setTask11() {
	...
	taskMap.startDate = "2020-07-15 02:05:00";
...
function setTask12() {
	...
	taskMap.startDate = "2020-07-07 23:21:00";
	taskList.push(new Array(type, "타워    ", "Lv.13", "1330만 골드", 11,  0));
	taskList.push(new Array(type, "타워    ", "Lv.13", "1330만 골드", 11,  0));
	taskList.push(new Array(type, "타워    ", "Lv.14", "1520만 골드", 12, 12));
	taskList.push(new Array(type, "타워    ", "Lv.14", "1520만 골드", 12, 12));
...
function setTask13() {
	...
	taskMap.startDate = "2020-07-09 23:24:00";
	taskList.push(new Array(type, "타워    ", "Lv.13", "1330만 골드", 11,  0));
	taskList.push(new Array(type, "타워    ", "Lv.14", "1520만 골드", 12, 12));
	taskList.push(new Array(type, "타워    ", "Lv.14", "1520만 골드", 12, 12));
	taskMap.taskList = taskList;
...
function setTask14() {
	...
	taskMap.startDate = "2020-07-05 17:40:00";
	taskList.push(new Array(type, "타워    ", "Lv.13", "1330만 골드", 11,  0));
	taskList.push(new Array(type, "타워    ", "Lv.13", "1330만 골드", 11,  0));
	taskList.push(new Array(type, "타워    ", "Lv.14", "1520만 골드", 12, 12));
	taskList.push(new Array(type, "타워    ", "Lv.14", "1520만 골드", 12, 12));
...
function setTask15() {
	...
	taskMap.startDate = "2020-07-02 21:28:00";
...
function setTask21() {
	...
	taskMap.startDate = "2020-07-11 23:54:00";
	taskList.push(new Array(type, "헬리곱터", "Lv. 1", "1800만 식량", 14,  7)); // 디지털
...
function setTask22() {
	...
	taskMap.startDate = "2020-07-09 23:49:00";
