function setTask11() {
	...
	taskMap.startDate = "2021-04-17 12:22:00";
...
function setTask12() {
	...
	var taskMap = new Object();
	var type = "국민2";
	taskMap.title = "1-2. 국민 (0명 → 3명)";
	taskMap.startDate = "2021-05-06 00:22:00";
	taskList.push(new Array(type, "대전차포", "Lv. 2", "  30만 골드",  1,  0));
	taskList.push(new Array(type, "대전차포", "Lv. 3", "  75만 골드",  3,  0));
	taskList.push(new Array(type, "대전차포", "Lv. 4", " 300만 골드",  4,  0));
...
function setTask13() {
	...
	taskMap.startDate = "2021-04-21 11:58:00";
...
function setTask14() {
	...
	taskMap.startDate = "2021-04-27 22:42:00";
...
function setTask21() {
	...
	taskMap.startDate = "2021-04-17 11:52:00";
	taskList.push(new Array(type, "엠알엘  ", "Lv. 6", "  25만 석유", 14,  6)); // 정보화
	taskList.push(new Array(type, "강습차량", "Lv. 1", "1800만 식량", 14,  7)); // 디지털
	taskList.push(new Array(type, "대기    ", "Lv. 1", "   0만 식량", 13,  0)); // 대기
...
function setTask22() {
	...
	taskMap.startDate = "2021-04-27 11:44:00";
